...
// three public API types it exposes are bundled here. These classes are compiled
// but excluded from the produced jar (see build.gradle) so that the real Zemlya mod
